...
if (user.email) {
        ...
        <div>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 12, marginBottom: 24 }}>
            <div style={{ background: '#f5f5f5', borderRadius: 8, padding: 16 }}>
              ...
              {String((analysis.summary as { creditsCompleted?: number })?.creditsCompleted ?? '')} /{'  '}
              {String((analysis.summary as { creditsRequired?: number })?.creditsRequired ?? '')}
              </div>
            </div>
            <div style={{ background: '#fff0f0', borderRadius: 8, padding: 16 }}>
              ...
              {String((analysis.summary as { missingRequirementsCount?: number })?.missingRequirementsCount ?? '')}
              </div>
            </div>
  ...
  {String((analysis.summary as { atRiskCount?: number })?.atRiskCount ?? '')}
</div>
            </div>
          </div>
